...
export default function KingdomScene({ night, keepLevel = 1, developed = false }: Props) {
  ...
  useEffect(() => {
    ...
    const ground=add(new THREE.CircleGeometry(94,64),mat(0x4d6635),0,-.08,0); ground.rotation.x=-Math.PI/2;
