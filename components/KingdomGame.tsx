...
export default function KingdomGame(){
 ...
 const lastCloudSave=useRef(0),saving=useRef(false),revision=useRef<number|null>(null),worldRefresh=useRef<(()=>void)|null>(null),chatEnd=useRef<HTMLDivElement|null>(null);
