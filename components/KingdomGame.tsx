...
type SharedMine={personalCap?:number;channelSlots?:number;orePerWorkerHour?:number;mine:{id:string;name:string;oreRemaining:number;extractedOre:number;totalWorkers:number;position:{x:number;z:number}};participants:Array<{id:string;name:string;workers:number;deliveredOre?:number;self:boolean}>};
