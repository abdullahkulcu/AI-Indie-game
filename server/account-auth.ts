...
export async function createSession(userId: string, cookieName = COOKIE) {
  ...
  return { token, cookie: `${cookieName}=${token}; Path=/; HttpOnly; Secure; SameSite=Lax; Max-Age=2592000` };
}
